...
public class ILoveYouTronWithFileChooser extends PApplet {
...
class FileChooser {
  public String choose(PApplet applet) {
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) { 
      ...
      println("File path is " + file.getPath());
      return file.getPath();
    }  
    else {
...
//    println("Sound level is " + soundLevel*10000/log(soundLevel*10000));
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#E2E2E2", "ILoveYouTronWithFileChooser" });
  }
}
