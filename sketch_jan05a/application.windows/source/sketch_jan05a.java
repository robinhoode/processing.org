...
public class sketch_jan05a extends PApplet {
...
public void mousePressed() {
  ...
  OscMessage myMessage = new OscMessage("/nudge");
  
  myMessage.add((float) mouseX); /* add an int to the osc message */
  myMessage.add((float) mouseY); /* add a second int to the osc message */
  myMessage.add((float) 0);
...
public void oscEvent(OscMessage theOscMessage) {
  ...
  */  
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#E2E2E2", "sketch_jan05a" });
  }
}
